...
const PolicyModal = ({ isOpen, onClose }: PolicyModalProps) => {
    return (
        <Modal isOpen={isOpen} onClose={onClose}>
            <div className="w-[800px] font-base flex flex-col gap-2 p-6 my-2">
                <h1 className="text-3xl font-bold text-center">Privacy Policy of eStudents</h1>
                <p className="pt-2">eStudents operates the estudents.xyz website, which provides the SERVICE.
                    This page is used to inform website visitors regarding our policies with the collection, 
                    use, and disclosure of Personal Information if anyone decided to use our Service, the eStudents website. 
                    ...
                    which is accessible at estudents.xyz, unless otherwise defined in this Privacy Policy.
                </p>
                <h2 className="text-2xl font-bold py-2">Information Collection and Use</h2>
                <p>For a better experience while using our Service, we may require you to provide us with certain personally identifiable information, 
                    including but not limited to your name, email and phone number. The information that we collect will be used to contact or identify you.</p>
                <h2 className="text-2xl font-bold py-2">Log Data</h2>
                ...
                <p>Cookies are files with small amount of data that is commonly used an anonymous unique identifier. 
                    These are sent to your browser from the website that you visit and are stored on your computer's hard drive.Our website uses these "cookies" 
                    to collection information and to improve our Service. You have the option to either accept or refuse these cookies, 
                    and know when a cookie is being sent to your computer. If you choose to refuse our cookies, you may not be able to use some portions of our Service.</p>
                <h2 className="text-2xl font-bold py-2">Service Providers</h2>
                ...
                <h2 className="text-2xl font-bold py-2">Links to Other Sites</h2>
